...
public class ConsolaParqueTestRunner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // Escenario 1: Login fallido y salir
            simularInteraccion("Login fallido y salir",
                "1", // Seleccionar Login
            ...
            // Escenario 2: Login Admin, ver atracciones y empleados, salir
            simularInteraccion("Login Admin y Consultas",
                "1", // Login
                "E005", // ID Admin
            ...
            // Escenario 11: Acciones Empleado (No Admin)
            ...
            simularInteraccion("Acciones Empleado (No Admin)",
                "1", // Login
                "E001", // ID Empleado
                "juanpass", // Contraseña
                "1", // Ver Atracciones
